...
export const About = () => {
  return (
    ...
    >
      ...
      <p className='mb-3'>
        На данный момент я <span className='font-bold'>студент 4 курса ОП "История" НИУ ВШЭ'25</span>. В дальнейшем
        планирую <span className='italic'>поступление в магистратуру "Магистер по наукам о данных"</span>. На данный
        момент я полностью уделяю всё своё свободное время своему любимому занятию -{" "}
